package com.example.kontakkucerdas;
...
public class AcyivityTambahContact {
    ...
    public class ActivityTambahContact extends AppCompatActivity {
        ...
        protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
            ...
            if (requestCode == IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null ){
                ...
                Toast.makeText(this, "Mohon Maaf Tidak ada gambar dipilih", Toast.LENGTH_SHORT).show();
            }
        }
            ...
            if(filePath != null){
                ...
                Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        ...
                        progressBar.setVisibility(View.INVISIBLE);
                        Toast.makeText(ActivityTambahContact.this, "Selamat,, Data berhasil disimpan", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
